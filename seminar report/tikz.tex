...
$\mathrm{i}\hbar \frac{\partial\Phi_k}{\partial t}= \Bra{\Phi_{k'}} \hat{T}_e\Ket{\Phi_{k'}} \Phi_k + \Bra{\chi\Phi_{k'}} \hat{V}_{n-e} \Ket{\chi\Phi_{k'}} \Phi_k, \quad k,k'=1...N \wedge k'\neq k $\\    
   \end{tabular} }; 
    ...
    %\node[op,below=of ehrenfestmd] (modifelect)($\mathrm{i}\hbar\frac{\partial \Phi}{\partial t}=$);
    ...
    \draw[arrw] (scfsinglepp) -- node[xshift=0,yshift=0]{classical limit $\hbar \to 0$} (ehrenfestmd);
\end{tikzpicture}
