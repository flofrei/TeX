...
\end{gather*}
The last term in the expectation is also known as advantage function. The actor critic algorithm 


In this thesis the actor critic architecture is of relevance since the option critic architecture from Bacon et al. (2017) \cite{bacon2017option} is based on it. The training in actor critic is a combination of value (critic) and policy (actor) based approach. \\
