...
Reinforcement Learning is besides supervised and unsupervised learning one of the big three themes in machine learning. Without going into details this research field is mostly based on the theory of Markov and semi-Markov decision processes. For the interested reader on the history and formation of reinforcement learning we refer to the well-known survey of Kaelbling et al. (1996) \cite{kaelbling1996reinforcement} were everything can be found. In this work we concentrate on one aspect of reinforcement learning namely hierarchical reinforcement learning. We think a good start where most frameworks are well summarized is in Barto et al.(2003) \cite{barto2003recent}. 
%Hierarchical reinforcement learning
The idea of using a hierarchy in reinforcement learning to increase efficiency is well established and goes back to the nineties. To summarize there are three major frameworks which were developed namely, the options framework of Sutton et al. (1999) \cite{sutton1999between}, the HAM(hierarchical abstract machines) framework of Parr et al. (1998) \cite{parr1998reinforcement}, and the MaxQ framework of Dietterich (2000) \cite{dietterich2000hierarchical}. 



The idea of options came from planning literature were macro actions were defined as a cumulation of simple actions put together and looked at as a single action
